...
- [Kotlin Multiplatform project structure](architecture/kmp-project-structure.md) — the recommended project layout and a comparison with `CMPMemeCreator`.
...
- [Absolute-beginner Hebrew research](research/01-absolute-beginner-hebrew-discovery.md)
- [Research summary tables](research/01-research-summary-table.md)
- [Audio production guide](assets/audio-production.md)
